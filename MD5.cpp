...
std::string MD5::startMD5(std::string source)
{
...
std::string MD5::getMD5Code(std::string source) {
	//初始化
...
unsigned int* MD5::padding(std::string str) {
...
//MD5 压缩函数 Hmd5 
void MD5::MD5compress(unsigned int M[]) {
	int f = 0, g = 0;
...
std::string MD5::changeToHex(int num) {
	int b;
	std::string tmp;
	std::string str = "";
